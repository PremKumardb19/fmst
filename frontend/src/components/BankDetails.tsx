...
const BankDetails: React.FC<{ register: any }> = ({ register }) => {
  ...
  return (
    <div className="space-y-4">
      ...
      <input
        ...
        onChange={(e) => setBankDetails("account_number", e.target.value)}
      ...
      <select
        ...
        onChange={(e) => setBankDetails("account_type", e.target.value)}
      ...
      <input
        ...
        onChange={(e) => setBankDetails("bank_name", e.target.value)}
        className="border p-3 rounded-lg w-full shadow-sm focus:ring-2 focus:ring-blue-400"
      ...
      <input
        ...
        onChange={(e) => setBankDetails("bank_address", e.target.value)}
        className="border p-3 rounded-lg w-full shadow-sm focus:ring-2 focus:ring-blue-400"
      ...
      <input
        ...
        onChange={(e) => setBankDetails("ifsc_code", e.target.value)}
        className="border p-3 rounded-lg w-full shadow-sm focus:ring-2 focus:ring-blue-400"
      ...
      <input
        ...
        onChange={(e) => setBankDetails("branch_code", e.target.value)}
        className="border p-3 rounded-lg w-full shadow-sm focus:ring-2 focus:ring-blue-400"
      ...
      <input
        ...
        onChange={(e) => setBankDetails("micr_code", e.target.value)}
        className="border p-3 rounded-lg w-full shadow-sm focus:ring-2 focus:ring-blue-400"
